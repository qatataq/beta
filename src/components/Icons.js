      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(50 12)">
          ...
          <rect
            fill="#9F9DEC"
            y="3"
            width={Math.floor(volume / 100 * 92)}
            height="4"
            rx="2"
          />
          <rect
            fill="#9F9DEC"
            x={Math.floor(volume / 100 * 82)}
            width="10"
            height="10"
            rx="5"
          />
        ...
        <g stroke="#918FEA">
          ...
          <g strokeWidth="2" strokeLinecap="round">
            {volume < 1 && (
              <path d="M27.235294 13.799424l6.34051 6.27134M33.575802 13.799424l-6.34051 6.27134" />
            )}
            {volume > 0 && (
              <path d="M31.720466 23.432645C33.710153 21.97526 35 19.636328 35 16.999426c0-2.636904-1.289847-4.975835-3.279534-6.433222M28.485172 20.89407c1.204548-.882297 1.985416-2.298275 1.985416-3.894646 0-1.59637-.780868-3.01235-1.985416-3.894646" />
            )}
            }
          </g>
        </g>
